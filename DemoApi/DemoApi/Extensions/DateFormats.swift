...
//        strDate = "\(strDate)"
    ...
    func timeAgoSinceDate(_ dateStr:String, numericDates:Bool) -> String
    {
        ...
        {
            //        //printMsg(val:  "date is smaller than current date ")
            //        //printMsg(val:  "Compoments year: \(components.year)")
            //        //printMsg(val:  "Compoments month: \(components.month)")
            //        //printMsg(val:  "Compoments weekOfYear: \(components.weekOfYear)")
            //        //printMsg(val:  "Compoments day: \(components.day)")
            //        //printMsg(val:  "Compoments hour: \(components.hour)")
            //        //printMsg(val:  "Compoments minute: \(components.minute)")
            //        //printMsg(val:  "Compoments second: \(components.second)")
