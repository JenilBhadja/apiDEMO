...
public extension UIView {
    ...
    @IBInspectable var cornerRadiusTopLeftAndRight: CGFloat {
        get {
            return layer.cornerRadius
        }
        set {
...
public extension UIView {
    ...
    func setRoundCorner(radius: CGFloat, TopRight: Bool, TopLeft: Bool, BottomRight: Bool, BottomLeft: Bool) {
        ...
        self.layer.cornerRadius = radius //layerMaxXMinYCorner layerMaxXMaxYCorner
...
//            printMsg(val: "Gif does not exist at that path")
            return nil
        }
...
extension UITabBarItem {
    ...
    @IBInspectable var fontSize : CGFloat{
        set{
            if(newValue > 0){
                let barItemFontAttributes = [NSAttributedString.Key.font : UIFont(name: "Poppins-Regular", size: newValue)]
...
extension MPVolumeView {
    ...
    public func setDeviceFullVolume() {
